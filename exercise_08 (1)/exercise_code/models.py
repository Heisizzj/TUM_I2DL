...
class Encoder(nn.Module):
    ...
    def __init__(self, hparams, input_size=28 * 28, latent_dim=20):
        ...
        self.encoder = nn.Sequential(
            ...
            nn.ReLU(),            
            nn.Linear(self.hparams["n_hidden1"], self.latent_dim)
         )
...
class Decoder(nn.Module):
    ...
    def __init__(self, hparams, latent_dim=20, output_size=28 * 28):
        ...
        self.decoder = nn.Sequential(
            nn.Linear(self.latent_dim, self.hparams["n_hidden1"]),
            nn.ReLU(),            
            nn.Linear(self.hparams["n_hidden1"], self.output_size)
         )
...
class Autoencoder(pl.LightningModule):
    ...
    def configure_optimizers(self):
        ...
        optim = torch.optim.SGD(self.encoder.parameters(), lr=0.1, momentum=0.9, weight_decay=1e-4)
...
class Classifier(pl.LightningModule):
    ...
    def __init__(self, hparams, encoder, train_set=None, val_set=None, test_set=None):
        ...
        self.model = nn.Sequential(
            nn.Linear(self.encoder.latent_dim, self.hparams["n_hidden2"]),
            nn.ReLU(),            
            nn.Linear(self.hparams["n_hidden2"], 10)
         )
    ...
    def configure_optimizers(self):
        ...
        optim = torch.optim.SGD(self.model.parameters(), lr=0.1, momentum=0.9, weight_decay=1e-4)
